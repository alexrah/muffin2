	...
	public function Show()
	{
		...
		if ($this->Params->get("resetbutton"))
		{
			switch ($this->Params->get("resettype"))
			{
				case 1:
					// input
					$result .= '<input class="btn btn-danger reset-button" type="reset" onClick="ResetFoxControls();" value="' . $this->Params->get("resettext") . '">' . PHP_EOL;
					break;
				...
				default:
					...
					$result .= '<button class="btn btn-danger reset-button" type="reset" onClick="ResetFoxControls();">' . PHP_EOL .
						'<span ';
